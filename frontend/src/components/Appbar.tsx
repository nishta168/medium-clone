...
const navigate =useNavigate();
    return(
        <div className="border-b py-4 flex justify-between dark:border-gray-700">
            ...
            <div className="flex">                
                <Link className="flex hover:text-gray-500 dark:text-gray-300 dark:hover:text-white" to={'/new-story'}>
                ...
                <div className="self-center mr-5">Write</div>
                </Link>
                <button className="self-center hover:text-gray-500 dark:text-gray-300 dark:hover:text-white mr-5" onClick={()=>{
